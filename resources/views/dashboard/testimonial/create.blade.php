                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Testimonial Info</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control" name="username_en" id="exampleInputEmail1" placeholder="Enter Client Name" value="{{old('username_en')}}">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control" name="username_ar" id="exampleInputEmail1" placeholder="ادخل اسم صاحب التوصية" value="{{old('username_ar')}}">
                                    <p class="help-block">ادخل اسم المستخدم صاحب التوصية</p>
                                </div>

                                <div class="col-lg-12">
                                    <label for="exampleInputEmail1">نص التوصية</label>
                                    <textarea type="text" class="form-control" name="text_ar" id="editor1" placeholder="ادخل نص التوصية">{{old('text_ar')}}</textarea>
