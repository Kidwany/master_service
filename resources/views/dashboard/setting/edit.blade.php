                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 with-border">
                                    ...
                                    <input type="email" class="form-control" name="website_name_en" id="exampleInputEmail1" placeholder="Enter Website Name" value="{{old('email')}}">
                                    <p class="help-block"> Enter Name of website </p>
                                </div>

                                <div class="col-lg-12 with-border">
                                    <label for="exampleInputEmail1">Website Description</label>
                                    <textarea type="email" class="form-control" name="website_description_en" id="exampleInputEmail1" placeholder="Enter Website Description" rows="6"></textarea>
                                ...
                                <div class="col-lg-12 with-border">
                                    ...
                                    <img src="{{asset('dashboard/img/picture.png')}}" data-toggle="modal" data-target="#update-img" class="img-responsive change-logo">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control" name="website_name_ar" id="exampleInputEmail1" placeholder="ادخل اسم الموقع" value="">
                                </div>

                                <div class="col-lg-12 with-border">
                                    <label for="exampleInputEmail1">وصف الموقع</label>
                                    <textarea type="email" class="form-control" name="website_description_en" id="exampleInputEmail1" placeholder="ادخل وصفا دقيقا للموقع" rows="6"></textarea>
                                </div>
