...
class AboutController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            'mission_ar'        => 'bail|required|min:50|max:1500',
            'vision_en'         => 'bail|required|min:50|max:1500',
            'vision_ar'         => 'bail|required|min:50|max:1500',
            'values_en'         => 'bail|required|min:50|max:1500',
            'values_ar'         => 'bail|required|min:50|max:1500',
            'description_en'    => 'bail|required|min:50|max:1500',
            'description_ar'    => 'bail|required|min:50|max:1500',
        ...
        $about->about_ar()->update(['about_id' => $about->id, 'mission' => $input['mission_ar'], 'vision' => $input['vision_ar'], 'value' => $input['values_ar'], 'description' => $input['description_ar']]);
